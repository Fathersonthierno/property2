...
//           Text(
//             "The Latitude Condo",
//             style: TextStyle(color: Colors.grey[300], height: 1.5, fontSize: 13),
//           ),
//           Text(
//             "The Latitude Condo",
//             style: TextStyle(color: Colors.grey[300], height: 0.9, fontSize: 13),
//           ),
//         ],
//       ),
//     );
...
//
//   const PropertyDetailCard({ key, required this.image, required this.title, required this.description})
//       : super(key: key);
